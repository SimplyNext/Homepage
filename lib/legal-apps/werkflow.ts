...
export const werkflowAgb: LegalSection[] = [
  ...
  },
  {
    ...
    afterList: [
      "(2) Die App wird in einer kostenlosen Testversion (3 kostenlose KI-Angebote und 3 kostenlose KI-Rechnungen, keine Kreditkartenangabe erforderlich) sowie in kostenpflichtigen Abonnement-Tarifen („Solo“, „Kleiner Betrieb“, „Pro“) angeboten. Der jeweilige Funktionsumfang der Tarife ergibt sich aus der Darstellung in der App zum Zeitpunkt des Vertragsschlusses. In der Testversion steht die Diktierfunktion (Sprache zu Text) nur zur Verfügung, solange noch kostenlose KI-Angebote oder KI-Rechnungen übrig sind; sind beide aufgebraucht, ist das Diktat ohne Abonnement gesperrt, auch über die Spracherkennung des Geräts. Mit einem Abonnement bleibt das Diktat auch nach Erreichen des monatlichen Kontingents verfügbar.",
